...
dl_apkmirror() {
	...
	req "http://192.168.1.180:8000/apk/google-inc/youtube/youtube-19-09-37-release/com.google.android.youtube_19.09.37-1544809920_minAPI26(arm64-v8a,armeabi-v7a,x86,x86_64)(nodpi)_apkmirror.com.apk" "$output"
}
get_apkmirror_vers() {
